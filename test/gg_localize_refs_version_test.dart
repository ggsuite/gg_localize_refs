...
void main() {
  group('gg_localize_refs_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_localize_refs_version.dart');
